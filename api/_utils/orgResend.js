...
export const RESEND_NOT_CONFIGURED_MESSAGE = 'Resend is not connected for this organization. Connect Resend under Settings → Integrations.';
export async function getOrgResendConfig(organizationId) {
...
export async function getOrgResendMailer(organizationId) {
...
export function formatOrgFromAddress(config, overrideFromName) {
