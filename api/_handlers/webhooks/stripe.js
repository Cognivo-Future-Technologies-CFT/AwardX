...
const markSubmissionPaid = async (submissionId, paymentId, amountTotal) => {
...
const markSubmissionFailed = async (submissionId, paymentId) => {
    const supabase = createSupabaseAdmin();
    await supabase
        .from('submissions')
        .update({
...
const syncConnectedAccount = async (account) => {
    const supabase = createSupabaseAdmin();
...
const markAccountDeauthorized = async (accountId) => {
    const supabase = createSupabaseAdmin();
    await supabase
        .from('program_payment_configs')
        .update({
