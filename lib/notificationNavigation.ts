...
const NOTIFICATION_TYPE_VIEWS: Record<string, string> = {
...
export function normalizeNotificationView(segment: string | null | undefined): string | null {
...
export function resolveNotificationPath(notification: NotificationNavigationInput): string {
